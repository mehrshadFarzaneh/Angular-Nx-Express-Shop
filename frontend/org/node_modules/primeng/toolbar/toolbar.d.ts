...
export declare class Toolbar implements AfterContentInit, BlockableUI {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<Toolbar, "p-toolbar", never, { "style": { "alias": "style"; "required": false; }; "styleClass": { "alias": "styleClass"; "required": false; }; }, {}, ["templates"], ["*"], false, never>;
}
