...
exports.exampleE2eProjectTslintJson = exports.exampleNonAngularProjectTslintJson = exports.exampleAngularProjectTslintJson = exports.exampleRootTslintJson = void 0;
// Based on latest Angular project root tslint.json + enforce-module-boundaries config from nx-examples
exports.exampleRootTslintJson = {
    raw: {
        rulesDirectory: [
...
exports.exampleAngularProjectTslintJson = {
    raw: {
        extends: '../../tslint.json',
        rules: {
...
exports.exampleNonAngularProjectTslintJson = {
    raw: {
        extends: '../../tslint.json',
...
exports.exampleE2eProjectTslintJson = {
    raw: {
        extends: '../../tslint.json',
        linterOptions: { exclude: ['!**/*'] },
        rules: {},
