...
function analyseEntryPoint(graph, entryPoint, entryPoints) {
    ...
    const compilerHost = (0, cache_compiler_host_1.cacheCompilerHost)(graph, entryPoint, tsConfigOptions, moduleResolutionCache, undefined, undefined, undefined, analysesSourcesFileCache);
