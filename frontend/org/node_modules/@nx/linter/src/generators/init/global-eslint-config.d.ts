...
export declare const getGlobalEsLintConfiguration: (unitTestRunner?: string, rootProject?: boolean) => LinterType.Config<LinterType.RulesRecord, LinterType.RulesRecord>;
