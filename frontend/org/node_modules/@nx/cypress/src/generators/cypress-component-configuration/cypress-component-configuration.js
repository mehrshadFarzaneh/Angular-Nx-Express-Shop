...
exports.updateTsConfigForComponentTesting = exports.cypressComponentConfiguration = void 0;
...
function normalizeOptions(options) {
    ...
    return Object.assign(Object.assign({}, options), { directory: (_a = options.directory) !== null && _a !== void 0 ? _a : 'cypress' });
}
...
function addProjectFiles(tree, projectConfig, opts) {
    ...
    (0, devkit_1.generateFiles)(tree, (0, devkit_1.joinPathFragments)(__dirname, 'files'), projectConfig.root, Object.assign(Object.assign({}, opts), { projectRoot: projectConfig.root, offsetFromRoot: (0, devkit_1.offsetFromRoot)(projectConfig.root), ext: '' }));
}
