import { AfterContentInit, AfterViewChecked, ChangeDetectorRef, ElementRef, EmbeddedViewRef, EventEmitter, OnDestroy, QueryList, TemplateRef, ViewContainerRef } from '@angular/core';
...
export declare class TabPanel implements AfterContentInit, OnDestroy {
    ...
    tabView: TabView;
    constructor(tabView: TabView, viewContainer: ViewContainerRef, cd: ChangeDetectorRef);
...
export declare class TabView implements AfterContentInit, AfterViewChecked, OnDestroy, BlockableUI {
    ...
    constructor(platformId: any, el: ElementRef, cd: ChangeDetectorRef);
    ngAfterContentInit(): void;
