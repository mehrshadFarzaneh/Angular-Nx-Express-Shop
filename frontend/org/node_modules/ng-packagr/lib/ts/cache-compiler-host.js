...
function cacheCompilerHost(graph, entryPoint, compilerOptions, moduleResolutionCache, emittedFiles, stylesheetProcessor, inlineStyleLanguage, sourcesFileCache = entryPoint.cache.sourcesFileCache) {
        ...
        writeFile: (fileName, data, writeByteOrderMark, onError, sourceFiles) => {
            ...
            if (fileName.endsWith('.d.ts')) {
                ...
                sourceFiles.forEach(source => {
                    emittedFiles === null || emittedFiles === void 0 ? void 0 : emittedFiles.add(source.fileName);
