...
import { AfterViewInit, ChangeDetectorRef, ComponentFactoryResolver, ComponentRef, ElementRef, NgZone, OnDestroy, Renderer2, Type } from '@angular/core';
...
export declare class DynamicDialogComponent implements AfterViewInit, OnDestroy {
    ...
    set style(value: any);
    get parent(): Element;
    constructor(document: Document, platformId: any, componentFactoryResolver: ComponentFactoryResolver, cd: ChangeDetectorRef, renderer: Renderer2, config: DynamicDialogConfig, dialogRef: DynamicDialogRef, zone: NgZone, primeNGConfig: PrimeNGConfig, parentDialog: DynamicDialogComponent);
    ...
    ngOnDestroy(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<DynamicDialogComponent, [null, null, null, null, null, null, null, null, null, { optional: true; skipSelf: true; }]>;
