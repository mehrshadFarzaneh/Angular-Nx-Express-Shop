...
export declare class ColumnFilter implements AfterContentInit {
    ...
    overlayEventListener: any;
    private window;
    constructor(document: Document, el: ElementRef, dt: Table, renderer: Renderer2, config: PrimeNGConfig, overlayService: OverlayService);
    ngOnInit(): void;
