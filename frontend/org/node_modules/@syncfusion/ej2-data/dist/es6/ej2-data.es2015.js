        ...
        if (typeof value === 'string') {
            ...
            if (ms) {
                ...
                if (isUTC) {
                    ...
                    const utcFormat = new Date(parseInt(arr[0], 10), parseInt(arr[1], 10) - 1, parseInt(arr[2], 10), parseInt(arr[3], 10), parseInt(arr[4], 10), parseInt(arr[5], 10));
...
class ODataAdaptor extends UrlAdaptor {
    ...
    processResponse(data, ds, query, xhr, request, changes) {
        ...
        const versionCheck = xhr && request.getResponseHeader('DataServiceVersion');
        let count = null;
...
class DataManager {
    ...
    */
            ...
            this.persistQuery.queries = this.persistQuery.queries.filter((query) => {
                ...
                if (query.fn === 'onWhere') {
                    ...
                    if (e && e.isComplex && e.predicates instanceof Array) {
                        const predicates = e.predicates.map((predicateObj) => {
    ...
    saveChanges(changes, key, tableName, query, original) {
        ...
        const doAjaxRequest = 'doAjaxRequest';
